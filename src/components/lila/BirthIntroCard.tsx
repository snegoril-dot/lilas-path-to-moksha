        ...
        >
          ...
          >
            ...
            <p className="mt-5 text-sm leading-relaxed opacity-85">
              Теперь путь будет откликаться не словами, а самими событиями на
              доске. Первый шаг — <b>рождение</b>. Брось кубик, чтобы войти
              в игру: врата откроет 🎲 <b>6</b>.
            </p>

            <p className="mt-2 text-xs opacity-60 leading-relaxed">
              Пока кубик молчит — можно заметить, что происходит внутри. Это тоже часть пути.
            </p>

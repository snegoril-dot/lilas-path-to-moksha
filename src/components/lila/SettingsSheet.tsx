          ...
          <div className="mt-4 space-y-2">
            ...
            <Section title="Приватность" icon={<Shield size={16} />}>
              <ul className="list-disc pl-4 space-y-1 opacity-80">
                <li>Личные заметки и Санкальпа остаются приватными. Они не попадают в шаринг и не используются без необходимости.</li>
                <li>Текст для «Поделиться» не содержит личные заметки, если вы сами их не добавите.</li>
                <li>Гуру видит только текущую клетку, Санкальпу и последние ходы — и только когда вы сами обращаетесь к нему. Полный дневник в контекст не попадает.</li>
